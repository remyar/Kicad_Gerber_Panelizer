...
namespace Kicad_gerber_panelizer
{
    ...
    public class GerberPanel
    {
        ...
        public void RenderInstanceHoles(Graphics G, float PW, Color C, AngledThing b, bool errors = false, bool active = false, bool hover = false)
        {
            if (b == null) return;
        ...
        public void RenderInstance(Graphics G, float PW, Color C, AngledThing b, bool errors = false, bool active = false, bool hover = false)
        {
            if (b == null) return;
            var T = G.Transform.Clone();
            ...
            if (b.GetType() == typeof(GerberInstance))
            {
                ...
                if (GerberOutlines.ContainsKey(GI.GerberPath))
                {
                  ...
                  /*  foreach (var Shape in a.TheGerber.DisplayShapes)
                    ...
                    PointD Ext = new PointD((Path.GetFileName(GI.GerberPath)).Length * 10, 10);
                    double Z = 1;
        ...
        private void FillShape(Graphics G, SolidBrush BR, PolyLine Shape)
        {
        ...
        private static void DrawMarker(bool cross, Graphics G, PointD pointD, float crossize, float PW, Pen P = null)
        {
            if (P == null)
        ...
        /// <param name="Shape"></param>
        private static void DrawShape(Graphics G, Pen P, PolyLine Shape)
        {
